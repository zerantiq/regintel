...
REQUIRED_FILES = [
    ...
    "scripts/sync_regulatory_feeds.py",
    "tests/base_test.py",
    "tests/test_signal_scan.py",
    "tests/test_ast_scan.py",
    "tests/test_gate.py",
    ...
    "tests/fixtures/repos/fintech/services/transaction_service.py",
    "tests/fixtures/repos/iot/services/device_gateway.py",
    "tests/fixtures/feeds/feed-config.json",
    "tests/fixtures/feeds/json-feed.json",
    "tests/fixtures/feeds/rss-feed.xml",
    "examples/ai-saas-scan-report.json",
    "examples/fintech-scan-report.json",
    "examples/healthcare-scan-report.json",
    "examples/compliance-gate-policy.json",
    "examples/regulatory-feed-config.json",
    "mkdocs.yml",
    "docs/index.md",
    "docs/installation.md",
    "docs/tutorials/ci-monitoring.md",
    "docs/tutorials/pypi-cli.md",
    "docs/integrations/agents.md",
    "docs/reference/script-contracts.md",
    "ROADMAP.md",
